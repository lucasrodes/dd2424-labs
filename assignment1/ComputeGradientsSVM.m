function [ grad_W, grad_b ] = ComputeGradientsSVM( X, Y, P, W, b, lambda )
%COMPUTEGRADIENTSSVM Computes the gradients of the model parameters (W, b)
% by minimizing the svm-multiclass loss function
%
% Inputs:
